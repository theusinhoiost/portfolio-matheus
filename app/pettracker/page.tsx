...
export default function PetTrackerShowcase() {
  return (
    <div className="min-h-screen font-sans selection:bg-(--accent) selection:text-white pb-20">
      ...
      <main className="max-w-5xl mx-auto px-6 pt-12">
        ...
        >
          {[
            { src: "/imgs/pet/pi.png", alt: "Página inicial do App" },
            {
              src: "/imgs/pet/dashboard.png",
              alt: "Dashboard dos Pets",
            },
          ].map((img, index) => (
